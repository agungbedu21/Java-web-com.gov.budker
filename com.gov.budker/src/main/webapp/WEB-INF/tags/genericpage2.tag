...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/component/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/component/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <!-- Datetimepicker -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/component/datetimepicker-4.17.47/bootstrap-datetimepicker.css">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/component/bootstrapvalidator/css/bootstrapValidator.css">
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/component/datatables.net-bs/css/dataTables.bootstrap.min.css">
</head>
...
<aside id="left-panel">
    ...
    <nav>
        ...
        <%--<ul class="menulist">--%>
            ...
            <%--<c:forEach items="${menuList}" var="dataMenu">--%>
                <%--<li id="#" style="display: block;">--%>
                    <%--<a href="${pageContext.request.contextPath}/${dataMenu.menuUrl}" data-original-title="" title="">--%>
                        <%--<i class="fa fa-lg fa-fw fa ${dataMenu.menuIcon}"></i>--%>
                        <%--<span class="menu-item-parent">${dataMenu.menuName}</span>--%>
