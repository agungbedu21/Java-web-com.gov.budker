        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/banktype/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "bankTypeName", "searchable": true},
                        {
                            "data": null,
                            "sortable": false,
                            "searchable": false,
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    '<li><a href="#" onclick="editBankTypeId(' + data.bankTypeId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteBankTypeId(' + data.bankTypeId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        },
                        {"data": "bankTypeId", "visible": false},
                    ],
                ...
                $("div.toolbar").html('<button class="btn btn-primary" onclick="addBankTypeId()"><i class="fa fa-plus"></i>Tambah</button>');
            ...
            function addBankTypeId() {
                var json;
                $.ajax({
                    cache: false,
                    type: "POST",
                    url: APP_PATH + "/app/banktype/modal",
            ...
            function editBankTypeId(BankTypeIdId) {
                var data = {
                    "bankTypeId": BankTypeIdId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteBankTypeId(BankTypeIdId) {
                $.ajax({
                    cache: false,
                    type: "POST",
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            ...
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/app/banktype/saveOrUpdate/' + 3,
                                'data': JSON.stringify(data),
                                'dataType': 'json',
                ...
                <div class="box-content">
                    <table id="datatable_fixed_column"
                        ...
                        <tr>
                            ...
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Filter Nama Tipe Bank"/>
                            </th>
                            <th>
                            </th>
                            <th>
                        ...
                        <tr>
                            <th width="2%">No.</th>
                            <th data-class="expand">Nama Tipe Bank</th>
