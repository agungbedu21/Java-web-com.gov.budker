        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/dir/datasource",
                        type: 'POST',
                        datatype: 'json',
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    '<li><a href="#" onclick="editDir(' + data.directorateId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteDir(' + data.directorateId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        },
                        {"data": "directorateId", "visible": false},
                    ],
                ...
                $("div.toolbar").html('<button class="btn btn-primary" onclick="addDir()"><i class="fa fa-plus"></i>Tambah</button>');
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            ...
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/app/dir/saveOrUpdate/' + 3,
                                'data': JSON.stringify(data),
                                'dataType': 'json',
