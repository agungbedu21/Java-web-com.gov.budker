        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/cal/deltacar/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "year", "searchable": true},
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return parseFloat(data.carMinValue).toFixed(2);
                            }
                        },
                        {
                            "data": null,
                            "render": function (data, type, full, meta) {
                                return parseFloat(data.carMaxValue).toFixed(2);
                            }
                        },
                        {"data": "achievement", "searchable": true},
//                        {
//                            "data": null,
//                            "render": function (data, type, full, meta) {
//                                if (data.isBprs == 0) {
...
//                        },
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    '<li><a href="#" onclick="editDeltaCar(' + data.deltaCarId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteDeltaCar(' + data.deltaCarId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        },
                        {"data": "deltaCarId", "visible": false},
                    ],
            ...
            function addDeltaCar() {
                ...
                $.ajax({
                    cache: false,
                    type: "POST",
                    url: APP_PATH + "/cal/deltacar/modal",
            ...
            function editDeltaCar(deltaCarId) {
                var data = {
                    "deltaCarId": deltaCarId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteDeltaCar(deltaCarId) {
                $.ajax({
                    cache: false,
                    type: "POST",
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            ...
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/cal/deltacar/saveOrUpdate/' + 3,
                                'data': JSON.stringify(data),
                                'dataType': 'json',
                ...
                <div class="box-content">
                    <table id="datatable_fixed_column"
                        ...
                        <tr>
                            ...
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Filter CAR Maksimum"/>
                            </th>
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Filter Pencapaian"/>
                            </th>
                                <%--<th class="hasinput">--%>
                                <%--<input type="text" class="form-control" placeholder="Filter Is Bprs"/>--%>
                                <%--</th>--%>
                            <th>
                        ...
                        <tr>
                            ...
                            <th data-class="expand">CAR Minimum</th>
                            <th data-class="expand">CAR Maksimum</th>
                            <th data-class="expand">Pencapaian</th>
                                <%--<th data-class="expand">Is Bprs</th>--%>
                            <th width="12%">
                                Status
                            </th>
                            <th width="12%">
