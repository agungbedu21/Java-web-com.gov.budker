        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/cal/sector/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "sectorName", "searchable": true},
                        {
                            "data": null,
                            "sortable": false,
                            "searchable": false,
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    '<li><a href="#" onclick="editSector(' + data.sectorId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteSector(' + data.sectorId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        },
                ...
                $("div.toolbar").html('<button class="btn btn-primary" onclick="addSector()"><i class="fa fa-plus"></i>Tambah</button>');
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            ...
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/cal/sector/saveOrUpdate/' + 3,
                                'data': JSON.stringify(data),
                                'dataType': 'json',
                ...
                <div class="box-content">
                    <table id="datatable_fixed_column"
                        ...
                        <tr>
                            ...
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Filter Nama Sektor"/>
                            </th>
                            <th>
                            </th>
                            <th>
                        ...
                        <tr>
                            <th width="2%">No.</th>
                            <th data-class="expand">Nama Sektor</th>
