        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/bud/budget/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "budgetYear", "searchable": true},
                        {
                            "data": null,
                            "render": function (data, type, full, meta) {
                                return "<p class='text-right'>" + formatRupiah2(data.budgetValue) + "</p>";
                            }
                        },
                        {
                            "data": null,
                            "render": function (data, type, full, meta) {
                                if (data.budgetRealization == null || data.budgetRealization === '') {
                                    return "<p class='text-right'>0</p>";
                                } else {
                                    return "<p class='text-right'>" + formatRupiah2(data.budgetRealization) + "</p>";
                                }
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                var result;
                                if (data.budgetRealization === '' || data.budgetRealization == null) {
                                    return "0";
                                } else {
                                    result = ((data.budgetRealization / data.budgetValue) * 100);
                                }
                        ...
                        },
                        {
                            "data": null,
                            "render": function (data, type, full, meta) {
                                return "<p class='text-right'>" + formatRupiah2(data.budgetValue - data.budgetRealization) + "</p>";
                            }
                        },
                        {
                            "data": null,
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    //                                    '<li><a href="#" onclick="viewBudget(' + data.budgetId + ')"><i class="fa fa-search"></i>Lihat Detail</a></li>' +
                                    '<li><a href="#" onclick="editBudget(' + data.budgetId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteBudget(' + data.budgetId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        }
                    ],
                ...
                $("div.toolbar").html('<button class="btn btn-primary" onclick="addBudget()"><i class="fa fa-plus"></i>Tambah</button>');
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/bud/budget/delete/' + budgetId,
                                'data': null,
                                'dataType': 'json',
                    ...
                    <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover"
                        ...
                        <tr>
                            <th style="border-right: none !important;">
                                ...
                                <%--<th class="hasinput">--%>
                                <%--<input type="text" class="form-control" placeholder="Filter Direktorat"/>--%>
                                <%--</th>--%>
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="Filter Divisi"/>
                            </th>
                            <th class="hasinput">
                        ...
                        <tr>
                            <th width="2%">No.</th>
                                <%--<th data-class="expand">Direktorat</th>--%>
                            <th data-class="expand">Divisi</th>
                            <th data-class="expand">Tahun</th>
                            <th data-class="expand">Anggaran</th>
                            <th data-class="expand">Realisasi (RP)</th>
                            <th data-class="expand">Realisasi (%)</th>
