        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/cal/bus/datasource",
                        type: 'POST',
                        datatype: 'json',
                        ...
                        {"data": "ikuTarget", "searchable": true},
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                if (data.achAvg == null) {
                                    ...
                                    var res = parseFloat(data.achAvg).toFixed(2);
                                    return res;
                                }
                            }
                        },
...
//                            "data": null,
//                            "render": function (data, type, full, meta) {
//                                var result = data.achAvg / data.ikuTarget;
//                                if (result > 110) {
//                                    return 110;
//                                }
//                                var res = parseFloat(result).toFixed(3);
//                                return res;
//                            }
//                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<div class="btn-group">' +
                                    ...
                                    '<li><a href="#" onclick="viewBus(' + data.calCarBusId + ')"><i class="fa fa-search"></i>Lihat Detail</a></li>' +
                                    '<li><a href="#" onclick="editBus(' + data.calCarBusId + ')"><i class="fa fa-pencil"></i>Ubah</a></li>' +
                                    '<li><a href="#" onclick="deleteBus(' + data.calCarBusId + ')"><i class="fa fa-trash"></i>Hapus</a></li>' +
                                    '</ul></div>';
                            }
                        }
                    ],
                ...
                $("div.toolbar").html('<button class="btn btn-primary" onclick="addBus()"><i class="fa fa-plus"></i>Tambah</button>');
            ...
            function viewBus(calBusId) {
                var json = {
                    "calCarBusId": calBusId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
                    url: APP_PATH + "/cal/bus/modalview",
                    data: JSON.stringify(json),
                    contentType: 'application/json',
                    beforeSend: function (xhr) {
                        $(".loading").show();
                    ...
                    success: function (data) {
                        ...
                        $("#submitDelete").click(function () {
                            $.ajax({
                                ...
                                'type': 'POST',
                                'url': APP_PATH + '/cal/bus/delete/' + calBusId,
                                'data': null,
                                'dataType': 'json',
