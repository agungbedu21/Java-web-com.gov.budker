...
//                        "division": $('#division').val(),
                    ...
                    $.ajax({
                        ...
                        'type': 'POST',
                        'url': APP_PATH + '/rep/reporting/finishinga/getDataTableReport',
...
//                var divId = $('#division').val();
                var year = $('#year').val();
                var tw = $('#triwulan').val();
                window.location.href = APP_PATH + "/rep/reporting/finishinga/downloadExcel/0/" + year + "/" + tw;
            }
