                    ...
                    <div class="modal-header">
                        ...
                        <h4 style="font-weight: 500;color: #000;" class="modal-title" id="myModalLabel">
                            ...
                            <input type="hidden" name="prokerId" value="${prokerData.prokerId}" id="prokerId"
                                   class="form-control"/>
                            <input type="hidden" name="isIku" value="${prokerData.isIku}" id="isIku"
                                   class="form-control"/>
                        </h4>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                <div class="col-md-12 col-xs-12 form-content shadow">
                                    ...
                                    <br/>
                                    <div id="ikuTable" <c:if test="${prokerData.isIku == 0}">hidden</c:if>>
                                            ...
                                            <div class="form-group">
                                                <div class="group-input">
                                                    ...
                                                    <table width="100%" id="tableIku" border="1">
                                                        ...
                                                        <tbody id="ikuTarget">
                                                        <%--<c:forEach items="${iku}" var="dt" varStatus="loop">--%>
                                                        <%--<tr>--%>
                                                        ...
                                                        <%--<input--%>
                                                        <%--type='hidden'--%>
                                                        <%--name='ikuTarget[]' value='${dt.target}'/>--%>
                                                        <%--${dt.target}--%>
                                                        <%--</td>--%>
                                                        ...
                                                        <c:forEach items="${ikuX}" var="dt" varStatus="loop">
                                                            <tr>
                                                                ...
                                                                <td style='text-align: left; padding : 1%'>
                                                                    <input type='hidden'
                                                                           name='ikuTarget[]' value='${dt.ikuTarget}'/>
                                                                        ${dt.ikuTarget}
                                                                </td>
                                                                <td style='padding:1%'><input type='text'
                                                                                              name='ikuRealization[]'
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style='padding:1%'>
                                                                    ...
                                                                    <input type='text'
                                                                           ...
                                                                           name='monthRealization[]' id="monthRealization${loop.index}"
                                                                           class='form-control'
                                                                           value="${rlz}"/>
                                                                </td>
                                                                <td style='padding:1%'>
                                                                    ...
                                                                    <input type='text' name='subsequence[]'
                                                                           class='form-control' id="subsequence${loop.index}"
                                                                           pattern="([0-9]+.{0,1}[0-9]*,{0,1})*[0-9]"
                                                                           value="${ssq}"/>
                                                                </td>
                                                            </tr>
...
//            $('#wizardForm').bootstrapValidator('revalidateField', 'startdate');
    ...
    function submitData() {
        ...
        $('#ikuTable').find('input[name="ikuTarget[]"]').each(function () {
            data.ikuTarget.push(
                $(this).val()
            );
        });
    ...
    function getProkerByDivAndYear(thisvar) {
        ...
        $.ajax({
            ...
            success: function (hasil) {
                ...
                for (i = 0; i < dataResult.length; i++) {
                    if (dataResult[i].mainProkerName !== null) {
